...
String Payment_ID = (String) session.getAttribute("paymentID");
		...
		Classfees classfees = classfeesservices.getClassfees(request.getParameter("id"));
	...
	<div class="page-container">
		...
		<div class="pageContainer">
			...
			<div class="container">
 			...
 			<h2> Update Student Class Fees Payment </h2>
			</div>
     			<form method="post" action="UpdateClassfees">

    <div class="col">
    <input name="Payment_ID" value="<%=classfees.getPayment_ID() %>" hidden>
    				
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Student ID</label>
      <input type="text" class="form-control"  value="<%=classfees.getStudent_ID() %>"  id="Student_ID" name = "Student_ID" placeholder="Student ID">
    </div>
  </div>
   ...
   <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" value="<%=classfees.getClassroom_id()%>" id="Classroom_id" name = "Classroom_id"  placeholder="Classroom ID">
    </div>
 </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control"  value="<%=classfees.getAmount()  %>"  id="Amount" name = "Amount"  placeholder="Payment">
    </div>
  </div>
   ...
   <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control"  value="<%=classfees.getValue() %>" id="Value" name = "Value"  placeholder="Amount Rs:">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="date" class="form-control"  value="<%=classfees.getDateAndTime() %>" id="DateAndTime" name = "DateAndTime"  placeholder="Date">
    </div>
  </div>

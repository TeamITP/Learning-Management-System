...
<link rel="stylesheet"
	href="adminstudent2/bootstrap/css/bootstrap.min.css">
...
<header>
	<div class="sidenav" id="navBarSide">
		...
		<div class="mainSideNav">
			...
			<a href="adminstudent1.jsp" class="active"><i
...
<body>
	<div class="pageContainer">
		...
		<ul class="nav nav-tabs nav-fill border-info">
			<li class="nav-item border rounded-0"><a
				class="nav-link active bg-primary" href="#">Students</a></li>
		</ul>
		<div>
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<div class="row">
							<div class="col" style="text-align: center; padding: 21px;">
						...
						<div class="row">
							<div class="col-md-12">
								<input type="text" style="text-align: left; margin: 13px;">
							</div>
						</div>
						<div class="row">
							<div class="col" style="text-align: center; padding: 14px;">
								<label><strong>No of Students</strong></label><input type="text">
							</div>
						</div>
						<div class="row">
							<div class="col" style="padding: 10px;">
								<input type="text" style="margin: 16px;">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col" style="padding: 15px;">
								<input type="text" style="margin: 9px;">
							</div>
						</div>
						<div class="row">
							<div class="col" style="text-align: center;">
					...
					<div class="col-md-6">
						<img
							src="adminstudent2/img/undraw_detailed_analysis_xn7y%20(1).png"
							width="400" height="500" style="padding: 42px;">
					</div>
				</div>
			</div>
		</div>

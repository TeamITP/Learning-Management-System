...
<link rel="stylesheet"
	href="EmployeeUpdate/bootstrap/css/bootstrap.min.css">
		...
		<div>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1
							style="border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; background-color: #297ce9; font-size: 25px; width: 910px; height: 45px; margin: 70px; padding: 10px; color: rgb(234, 243, 255);">Employee
							Profile Update</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<form action="EmployeeUpdate" method="post">
							...
							<div
								style="height: 435px; border: 3px solid rgb(41, 124, 233); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; margin: 60px; padding: 20px; width: 380px;">
								<div class="row">
									<div class="col">
								...
								<div class="row">
									<div class="col" style="padding: 10px;">
										<input type="text" value="<%=employee.getName()%>"
											...
											style="width: 320px; padding: 2px; height: 30px; border: 2px solid rgb(0, 123, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;">
									</div>
								</div>
								<div class="row">
									<div class="col" style="padding: 10px;">
										<input type="text" value="<%=employee.getAddress()%>"
											...
											style="height: 30px; width: 320px; border-style: solid; border-color: rgb(0, 123, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;"
											placeholder="Address">
									</div>
								</div>
								<div class="row">
									<div class="col" style="padding: 10px;">
										<input type="text" value="<%=employee.getPhone()%>" id="phone"
											name="phone"
											style="width: 320px; border-style: solid; border-color: rgb(0, 123, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;"
											placeholder="Phone">
									</div>
								</div>
					...
					<div class="col-md-6">
						<img src="EmployeeUpdate/img/updateEmp.png"
							style="width: 350px; height: 350px; padding: 20px; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; margin: 70px;">
					</div>
				</div>
			</div>
		</div>

							...
							<div class="col">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputEmail4">Student ID</label> <input type="text"
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputEmail4">Classroom ID</label> <input
											type="text" class="form-control" id="Classroom_id"
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputEmail4">Value</label> <input type="text"
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputEmail4">Date</label> <input type="date"
											class="form-control" id="DateAndTime" name="DateAndTime"
											placeholder="Date">
									</div>
								</div>

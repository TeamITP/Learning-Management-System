...
<link rel="stylesheet" href="CSS/expendi.css">
<link rel="stylesheet"
...
<script type="text/javascript" src="node_modules/mdbootstrap/js/mdb.min.js"></script>
	...
	<div class="sideNav">
		...
		<a href="paymentHome.jsp" ><i
			...
			<a href="ClassFee_pmt.jsp"><i
				...
				href="expendi.jsp"  class="active"><i class="fas fa-file-invoice-dollar iconMainNavi"></i>Expenditure</a> <a
				href="expendi.jsp"> <i
  ...
  <button type="submit" class="btn btn-outline-danger">Delete</button>
    				...
    				<div class="col">
     						 <div class="imgPMT">
  			<img src="Images/expendi.png"  style="width:600px">
  			</div>
			</div>

                    ...
                    <div class="col">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <div><input class="form-control" type="text" style="border-color: #197dff;"></div>
                                <div style="padding-top: 5px;"><input class="form-control" type="email" style="border-color: #197dff;"></div>
                                <div style="padding-top: 5px;"><input class="form-control" type="text" style="border-color: #197dff;"></div>
                                <div style="padding-top: 5px;"><input class="form-control" type="date" style="border-color: #197dff;"></div>
                                <div style="padding-top: 5px;"><input class="form-control" type="text" style="border-color: #197dff;"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <div><input class="form-control" type="text" style="border-color: #197dff;height: 70px;"></div>
                                <div style="padding-top: 5px;"><input class="form-control" type="text" style="border-color: #197dff;height: 70px;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col">

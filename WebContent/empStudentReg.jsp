...
<link rel="stylesheet"
	href="studentregistration/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet"
	href="studentregistration/css/Contact-Form-Clean.css">
	...
	<div class="sideNav">
		...
		<div class="mainSideNav">
			...
			<a href="empTeacherReg.jsp"><i
				...
				href="empStudentReg.jsp" class="active"> <i
		...
		<div class="pageContainer">
			<div class="contact-clean">
                ...
                <div class="col"><label>Enter Gaurdian Name</label><input class="form-control" name = "Guardian" type="text" required></div>
						...
						<div class="col">
							<label>Enter the Phone Number</label><input class="form-control"
								name="phone" type="text" required>
						</div>
						<div class="col">
							<label>Enter the Gaurdian Name</label><input class="form-control"

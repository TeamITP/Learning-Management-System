<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <head>
        ...
        <script src="JS/insertAc.js"></script>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="pageContainer">
                ...
                <div id="pdfContainer">
                <img src="Images/pdf.png" id="imgPdf">
                <h5 id="fileName"></h5></div>
                </label>
                        </div>
                </div>
                <input onchange="inputChanged()" type="file" name="file" id="fileUpload" hidden/>
                <div class="row">
                    <button type="button" class="btn btn-primary" name="btnSubmit" id="btnSubmit">Next</button>
                </div>
                </form>
                <div id="warning">
  Make sure your input is a pdf document
</div>
            </div>
            <!--Footer Here-->

			...
			<div class="pageTopicContainer">
				...
				<form>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputEmail4">Teacher ID </label> <input type="text"
								class="form-control" id="" placeholder="Payment ID"
								id="Student_ID" name="Teacher_ID">
						</div>
						<div class="form-group col-md-6">
							<label for="inputEmail4">Teacher Rate</label> <input type="text"
								class="form-control" id="" placeholder="Teacher Rate"
								id="Student_ID" name="Rate">
						</div>
				...
				<div>
					<div class="form-group col-md-6">
						...
						<p id="result"></p>
						<button type="submit" class="btn btn-primary" onClick="BMI()">Calculate
							Income</button>

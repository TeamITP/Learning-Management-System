		...
		<form method="post">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="lastName"
					placeholder="Last Name" value=<%=student.getLastName()%> readonly>
				<textarea class="form-control" type="text" name="address"
					placeholder="Address" readonly><%=student.getAddress()%></textarea>
				<input class="form-control" type="text" name="phone"
					placeholder="Phone Number" value=<%=student.getPhone()%> readonly><input
					class="form-control" type="text" name="Guardian"
					placeholder="Guardian Name" value=<%=student.getGuardian()%>
					readonly><input class="form-control" type="text"
					name="password" placeholder="Password"
					value=<%=student.getPassword()%> readonly>
			</div>
		</form>
	</div>
	<div class="col"></div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<a href="updateStudent.jsp">
						<button class="btn btn-warning" type="button">Update
							Profile</button>
					</a>
				</div>
				<div class="col-md-4">

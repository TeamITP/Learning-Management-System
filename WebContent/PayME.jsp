...
<body>
    ...
    <form class="form-signin">       
      ...
      <input type="text" class="form-control" name="SID" placeholder="Student ID" required="" autofocus="" />
      <input type="password" class="form-control" name="CID" placeholder="Classroom ID" required=""/>      

		...
		<div class="pageContainer">
			...
			<div>
				<div class="row" style="padding-top: 20px;">
					<div class="col"
						style="padding-left: 50px; padding-right: 50px; padding-top: 0px; padding-bottom: 10px; border-style: none;">
						<div
							style="padding-left: 50px; padding-right: 50px; padding-top: 10px; background-color: #006FFF; border-radius: 5px;">
							<label style="color: rgb(248, 250, 251); font-size: 20px;">Teacher</label>
						</div>
					</div>
				</div>
				<div class="row"
					style="padding-right: 50px; padding-left: 50px; padding-top: 30px;">
					<div class="col">
						<div>
							<div class="col"
								style="border-radius: 5px; border-style: solid; border-color: #006FFF;">
								<div class="row"
									style="border-style: solid; border-color: #006FFF;">
									<div class="col">
										<label class="col-form-label"
											style="color: #006FFF; padding-left: 40px;">Physical
											Science Stream</label>
									</div>
								</div>
									...
									<div class="col">
										<div class="row">
											<div class="col"
												...
												<div
													style="border-radius: 5px; border: 1px solid rgb(52, 147, 242); padding-bottom: 10px;">
													<div class="row">
														<div class="col">
															<label class="col-form-label" style="padding-left: 20px;">Combined
																Mathematics</label>
														</div>
													</div>
													<div class="row">
														<div class="col" style="padding-left: 40px;">
															<div
																style="border-radius: 5px; background-color: #0099FF; border-style: solid; border-color: #0099FF; width: 85px;">
																<label
																	style="color: rgb(245, 246, 248); font-size: 11px;">No
																	Of Teachers</label>
															</div>
														</div>
														<div class="col">
															<div
																style="height: 36.8px; border-radius: 5px; border-style: solid; border-color: #0099FF;"></div>
														</div>
														<div class="col"></div>
													</div>
													<div class="row" style="padding-top: 10px;">
														<div class="col" style="padding-left: 40px;">
															<div
																style="border-radius: 5px; background-color: #0099FF; border-style: solid; border-color: #0099FF; width: 85px;">
																<label
																	style="color: rgb(245, 246, 248); font-size: 11px;">Teachers
																	Names</label>
															</div>
														</div>
														<div class="col">
					...
					<div class="col" style="border-color: #0099FF;">
						<div>
							<img
								src="AdminSubject/img/undraw_detailed_analysis_xn7y%20(1).png"
								style="padding-top: 200px; width: 500px; padding-left: 50px;">
						</div>
					</div>
				</div>
			</div>

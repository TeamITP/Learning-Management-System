	...
	<!-- Header here -->
        ...
        <div class="col" style="padding-right: 15px;border-style: solid;border-color: rgb(246,247,249);margin-right: 10px;">
                ...
                <div class="col">
                    <div style="padding-right: 50px;padding-left: 50px;">
                        <div class="col" style="border-radius: 5px;border-style: solid;border-color: #0088FF;">
                            ...
                            <div class="row">
                                <div class="col" style="height: 25px;"><label class="col-form-label">Dharmaraja&nbsp; Collage&nbsp; Kandy</label></div>
                            </div>
                            <div class="row">
                                <div class="col"><label class="col-form-label">University Of Peradeniya&nbsp;</label></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" style="padding-top: 5px;padding-right: 50px;padding-left: 50px;margin-top: 10px;">
                <div class="col"><button class="btn btn-primary" type="button" onclick="location.href='#'"style="color: rgb(252,251,251);background-color: rgb(249,18,46);">Delete Account</button></div>
                ...
                <div class="col" style="width: 70.5px;">
                    <div class="row">
                        ...
                        <div class="col" style="padding-top: 20px;padding-right: 60px;">
                            <div style="padding-top: 10px;"><button class="btn btn-primary" type="button" onclick="location.href='Student_feedback.jsp'"style="width: 250px;">See Student Feedback</button></div>
                        </div>
                    </div>
                </div>

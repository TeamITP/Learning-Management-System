	...
	<div class="sideNav">
		...
		<div class="mainSideNav">
			<a href="teacherClassroom.jsp"><i
				...
				href="teacherExams.jsp" class="active"><i
				class="fas fa-poll iconMainNavi"></i>Exam Marks</a> <a
	...
	<div class="page-container">
		...
		<div class="pageContainer">
			...
			<form action="ResultTeacherView" method="post">
				...
				<button type="submit" class="btn btn-primary btn2">Re-Correction
					Apply</button>
			...
			<img src="Images/image-recorrection.png" class="picture" width="800"
				height="400">

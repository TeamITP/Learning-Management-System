	...
	<div class="sidenav" id="navBarSide">
		...
		<div class="mainSideNav">
			...
			<a href="adminTeacher.jsp"><i
				...
				href="adminEmployee.jsp" class="active"><i
		...
		<div>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1
							style="font-size: 25px; padding: 10px; background-color: #006fff; color: rgb(255, 255, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; height: 45px; width: 910px; margin: 10px;">Employee</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<form onsubmit="return validate()" action="EmployeeInsert"
							method="post">
							<div
								style="width: 380px; height: 380px; margin: 60px; padding: 20px; border: 3px solid rgb(0, 111, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;">
								<div class="row">
									<div class="col" style="padding: 10px;">
										<input type="text" placeholder="Full Name " id="fullname"
											name="fullname"
											style="width: 320px; border-color: rgb(0, 123, 255); border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;">
									</div>
								</div>
								<div class="row">
									<div class="col" style="padding: 10px;">
								...
								<div class="row">
									<div class="col" style="padding: 10px;">
										<input type="text" placeholder="Phone" id="phone" name="phone"
											style="width: 320px; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; border-color: rgb(0, 123, 255);">
									</div>
								</div>
								<div class="row">
									<div class="col" style="padding: 10px;">
									...
									<div class="col" style="padding: 10px;">
										<div class="form-check">
											<input class="form-check-input" type="checkbox"
												id="formCheck-1" style="border: 3px solid rgb(0, 109, 255);"><label
												class="form-check-label" for="formCheck-1"
												style="width: 320px; font-size: 12px;">Above details
												are correct and agreed for the terms and conditions of the
												institute.</label>
										</div>
									</div>
								</div>
					...
					<div class="col-md-6">
						<img src="EmployeeRegister/img/registerEmp.png"
							style="width: 350px; height: 350px; text-align: center; margin: 65px; padding: 10px;">
					</div>
				</div>
			</div>
		</div>

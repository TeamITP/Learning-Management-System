	...
	<div class="sideNav">
		...
		<div class="mainSideNav">
			...
			<a href="ClassFee_pmt.jsp"><i
				...
				class="fas fa-file-invoice-dollar iconMainNavi"></i> Employee Salary</a>
			<a href="teacherNotices.jsp"><i
				...
				<form>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputEmail4">Employee ID </label> <input type="text"
								class="form-control" id="" placeholder="Employee ID">
						</div>
						<div class="form-group col-md-6">
							<label for="inputEmail4">Employee Contract </label> <input
